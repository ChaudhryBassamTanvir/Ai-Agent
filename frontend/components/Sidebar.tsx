...
import { MessageSquare, LayoutDashboard, Users, LogOut } from "lucide-react"
  ...
  return (
    <aside className="w-[220px] flex-shrink-0 bg-[#fafaf9] border-r border-[#e8e8e6] flex flex-col h-screen fixed left-0 top-0">
      ...
      <div className="p-5 border-b border-[#e8e8e6]">
        <div className="text-[15px] font-medium tracking-[-0.3px]">DS Technologies</div>
        <div className="text-[11px] text-[#999] mt-[2px]">Agent Dashboard</div>
      </div>
      ...
      <div className="p-4 border-t border-[#e8e8e6]">
        ...
        <button
          onClick={logout}
          className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-[13px] text-[#888] hover:text-red-600 hover:bg-red-50 hover:border-red-100 border border-transparent transition-colors cursor-pointer bg-transparent"
        >
          <LogOut size={14} />
          Sign Out
        </button>
